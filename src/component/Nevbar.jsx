...
import logo_1 from "../Images/IndiadealsLogo.png";
import {
  Grid,
} from "antd";
import {
...
const Navbar = () => {
  ...
  return (
    <header className="w-full shadow-md sticky top-0 z-50">
      ...
      {/* 🔷 TOP NAVBAR */}
      <div className="bg-[#001A2D] text-white py-2">
        <div className=" mx-auto px-2 md:px-[40px]  flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <div
              ...
              className="md:flex items-center gap-1 cursor-pointer text-[large] flex mx-5"
            >
          ...
          <div className="hidden md:flex items-center gap-4">
            <div className=" hidden md:block">
              <div className="max-w-7xl mx-auto   flex justify-center gap-5 text-gray-700 font-medium">
            ...
            {user.loggedIn ? (
              <div className="relative">
                ...
                >
                  {/* Profile Circle */}
                  <div className="w-7 h-7 rounded-full bg-white text-[#001A2D] flex items-center justify-center font-bold text-sm uppercase shadow-md">
                  ...
                  <FaChevronDown
                    size={12}
                    className={`transition-all duration-300 ${profileOpen ? "rotate-180" : ""
                      }`}
                  />
                </div>
                ...
                {directLinks.includes(menu) ? (
                  ...
                  <div className="border-b border-gray-300">
                    ...
                    >
                      ...
                      <FaChevronDown
                        size={11}
                        className={`transition-all duration-300 ${open === menu ? "rotate-180" : ""
                          }`}
                      />
                    </button>
