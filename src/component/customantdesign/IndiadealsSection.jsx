  ...
  return (
    <section className="mt-[100px]">
      <h4 className="text-3xl heading-h3 font-bold text-[#001f3f]  tracking-wide mb-[30px]">
        WHY INDIADEALS GROUP IS THE RIGHT CHOICE
      </h4>
              ...
              <div className="absolute inset-0 animate-[spin_18s_linear_infinite]">
                 <svg viewBox="0 0 100 100" className="w-full h-full p-1">
                  ...
                  <text className="text-[10px] fill-white uppercase tracking-tighter">
                    <textPath xlinkHref="#circlePath" startOffset="0%" textLength="230"  lengthAdjust="spacing">Indiadeals group . Indiadeals group . Indiadeals group .</textPath>
                  </text>
                </svg>
              </div>
            </div>
