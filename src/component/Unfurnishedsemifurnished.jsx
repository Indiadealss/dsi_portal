...
const tableOfContents = [
    { id: "exclusive-new-project-launched-in-greater-noida-by-irish-group", label: "Exclusive: New Project Launched in Greater Noida by Irish Group" },
  { id: "project-layout", label: "Project Layout" },
  { id: "versatile-living-spaces", label: "Versatile Living Spaces" },
  { id:"amenities-strategic-connectivity", label: "Amenities & Strategic Connectivity"},
  { id:"the-pre-launch-investment-advantage", label: "The Pre-Launch Investment Advantage"}
];
