...
const SECTIONS = [
  ...
  },
  {
    ...
    content: {
      intro: "DSI INDIADEALS PRIVATE LIMITED. provides:",
      items: [
  ...
  },
  {
    ...
    content: {
      intro: "All content on our Platform—including text, images, logos, graphics, brochures, and materials—is the exclusive property of DSI INDIADEALS PRIVATE LIMITED ",
      items: [
            "Copy",
            "Reproduce",
            "Modify",
  ...
  },
  {
    ...
    content: {
      intro: "DSI INDIADEALS PRIVATE LIMITED is not liable for:",
      items: [
            ...
            <aside style={{ width: "260px", flexShrink: 0, position: "sticky", top: "125px", display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ background: "linear-gradient(135deg, #EFF6FF 0%, #F0F9FF 100%)", border: "1px solid #BFDBFE", borderRadius: "12px", padding: "20px" }}>
                ...
                <p style={{ margin: 0, fontSize: "12.5px", color: "#6B7280", lineHeight: 1.7 }}>
                  By using Indiadeals group, you agree to these terms and condition.
                </p>
              </div>
            </aside>
          )}
