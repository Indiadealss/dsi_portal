    ...
    return (
        <section id='loginForm' className=''>
            ...
            <form className="max-w-sm mx-auto">
                ...
                <label for="email-address-icon" className={`${form ==='Login' ? ' block mb-2 text-sm font-medium text-gray-900 ':'hidden'}`}>Name</label>
                <div className={`${form === 'Login' ? 'flex' : 'hidden'}`}>
                    ...
                    <input type="text" id="website-admin" onChange={(e) => setIname(e.currentTarget.value)} className={`${form === 'Register' ? 'hidden': 'rounded-none rounded-e-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5     '}`} placeholder="Full Name" />
                </div>
                <label for="email-address-icon" className='my-4 block mb-2 text-sm font-medium text-gray-900 '>Your Email</label>
                ...
                {/* <div className="relative">
                    ...
                    <input type="text" id="name-address-icon" className="bg-gray-50 my-10 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5     " placeholder="Full Name" />
                </div> */}

                <div className={`${form === 'Password' ? 'hidden' : 'my-5'}`}>
                    <label for="password" className="block mb-2 text-sm font-medium text-gray-900 ">Password</label>
                    <input type="password" id="Password" onChange={(e) => setPassword(e.currentTarget.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="•••••••••" required />
                ...
                <div className={`${form === 'Login' ? 'my-5' : 'hidden'}`}>
                    ...
                    <input type="password" id="ConformPassword" onChange={(e) => setConformPassword(e.currentTarget.value)} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5    " placeholder="•••••••••" required />
