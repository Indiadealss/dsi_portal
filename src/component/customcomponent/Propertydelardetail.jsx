        ...
        <div>
            ...
            <div className='flex flex-col lg:flex-row'>
                <div>
                    ...
                    <div className='bg-white shadow-md max-w-sm  border-x border-t border-gray-300'>
                    ...
                    <div className='bg-white shadow-md max-w-sm  border border-gray-300'>
                        <div className='flex  px-3 pt-3'>
                            <div>
                ...
                <div className='ms-4'>
                    ...
                    <div className='mt-5'>
                        <div className='flex'>
                            ...
                            <div className="flex items-center">
                                ...
                                <label for="default-radio-1" className="m-2 text-sm  text-gray-500 dark:text-gray-300">Individual </label>
                            </div>
                            <div className="flex items-center" >
                                ...
                                <label for="default-radio-2" className="m-2 text-sm  text-gray-500 dark:text-gray-300">Dealer</label>
                            </div>
                        </div>
                    </div>
                    <div className=''>
                        <div className='flex '>
                            ...
                            <div className="flex items-center">
                                ...
                                <label for="default-radio-1" className="m-2 text-sm  text-gray-500 dark:text-gray-300">Investment </label>
                            </div>
                            <div className="flex items-center" >
                                ...
                                <label for="default-radio-2" className="m-2 text-sm  text-gray-500 dark:text-gray-300">Self use</label>
                            </div>
                        </div>
                    </div>
                    <div className='flex flex-col lg:flex-row'>
                        ...
                        <div>
                            <textarea id="message" rows="4" class="block m-0 lg:mx-2 p-2.5 w-full text-sm text-gray-900 bg-gray-50  border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="I am interested in this Property." maxLength={400} minLength={5} onInput={(e) => setIntrested(e.target.value.length)}></textarea>
                    ...
                    <div>
                        <div class="flex items-center">
                            ...
                            <label for="checked-checkbox" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree to the Trems & Conditions and Privacy Policy</label>
                        </div>
