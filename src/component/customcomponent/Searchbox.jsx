  ...
  return (
    <>
      ...
      >
            ...
            <div className={`${buttonName === 'postedby' ? 'flex mt-5 mx-10' : 'hidden'}`}>
              ...
              <div className={`${active === 'commercial' ? 'block': 'hidden'}`}>
                ...
                <div class="flex items-center">
                    ...
                    <label for="default-radio-4" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Buy</label>
                </div>
                <div class="flex items-center">
                ...
                <div class="flex items-center">
                    ...
                    <label for="default-radio-3" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Invest</label>
                </div>
                </div>
        ...
        {(active === 'commercial') && showDropdown2 && (
          <div className=" top-full left-0 w-full bg-white shadow-lg rounded-xl p-5 z-0">

            <div className='flex justify-between'>
              <div className={`${!searButton ? 'hidden' : "grid grid-cols-2 gap-4 my-4 w-[50%]"}`}>
              ...
              <div className='grid grid-cols-2 gap-2 my-4 w-[40%]'>
                <div>
