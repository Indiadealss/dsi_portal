            ...
            <div className='border-b border-gray-300'>
                <div className='mx-10 hidden lg:block'>
                    ...
                    <div className='flex'>
                        ...
                        {/* details */}
                        <div className='hidden lg:block lg:absolute bg-white shadow-md   right-5 rounded-lg border border-gray-300'>
                            ...
                            <div className='flex w-full bg-blue-100 py-2 rounded'>
                                ...
                                <p><span className='px-2 font-medium text-gray-500'>{property.commercialType === 'redyOfficeSpace' ? `Ready to move ${property.propertyType} Space` : `${property.propertyType} Property`}</span></p>
                                <p><span className='px-2 border-s font-medium text-gray-500'>Posted on {new Date(property.updatedAt).toLocaleDateString("en-US", {
                                            month: "long",
                                            day:"numeric",
                                            year: "numeric",
                                        })}</span></p>
