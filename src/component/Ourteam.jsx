...
import soniMam from '../Images/Soni-mam.webp';
import saurabh from '../Images/saurabhYadav.jpg';
import Deepusir from '../Images/DeepuSir.webp';
import RichaMam from '../Images/richmam.webp';
      ...
      <div className=''>
        ...
        <div className='p-0 md:p-10 bg-opacity-0'>
          ...
          <div className='shadow-xl md:mx-10 mt-10 py-3    bg-white flex flex-col md:flex-row'>
            <div>
              <div className='   overflow-hidden ms-4'>
                <img src={soniMam} alt='...' className='w-80 rounded-t-full' />
              </div>
          ...
          <div className='shadow-xl md:mx-10 mt-10 py-3 my-10    bg-white flex flex-col md:flex-row'>
            <div>
              <div className='   overflow-hidden ms-4'>
                <img src={Deepusir} alt='...' className='w-80 rounded-t-full' />
              </div>
          ...
          <div className='shadow-xl md:mx-10 mt-10 py-3    bg-white flex flex-col md:flex-row'>
            <div>
              <div className='   overflow-hidden ms-4'>
                <img src={saurabh} alt='...' className='w-80 rounded-t-full' />
              </div>

              <h1 className='text-center text-[#313036] uppercase font-black text-xl'>Mr. Saurav yadav</h1>
            </div>

            <div className='mt-10 ms-4'>
              <h1 className='font-bold text-[#313036] text-xl uppercase'>President - Sales & Marketing</h1><br />
              <div className='w-[85vw] md:w-[60vw] ms-4 pe-10'>
                <p className='text-justify text-gray-600'>
                  <span className='text-justify text-gray-600 leading-6'>
                    With over 10+ years of dedicated experience in the real estate sector, Saurav  brings a sophisticated, analytical approach to the property market, underpinned by the strategic foundations of an MBA in Marketing from Graphic Era University, Dehradun. Over the past ten years, Saurav has cultivated a reputation for excellence by bridging the gap between complex market dynamics and high-value investment opportunities, ensuring that every client benefits from data-driven insights and meticulous attention to detail. His expertise spans the full spectrum of the industry, specializing in all types of residential and commercial properties—from luxury home acquisitions to high-stakes corporate developments—driven by a commitment to transparency, professional integrity, and long-term asset growth. By leveraging his advanced academic background in marketing and a deep-rooted understanding of regional real estate trends, Saurav provides a seamless, end-to-end consultancy experience that transforms property transactions into strategic legacy-building milestones.
                  </span>
                </p>
              </div>
            </div>
          ...
          <div className='shadow-xl md:mx-10 mt-10 py-3 my-10    bg-white flex flex-col md:flex-row'>
            <div>
              <div className='   overflow-hidden ms-4'>
                <img src={RichaMam} alt='...' className='w-80  rounded-t-full' />
              </div>
