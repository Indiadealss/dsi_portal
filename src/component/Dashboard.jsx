...
const Dashboard = () => {
    ...
    lead(user.id)
      .then(res => {
        if (res.status === 200) {
          ...
          console.log(res, 'data is in this')
  ...
  const fetchDashboard = async () => {
    ...
    return {
      userName: user.name,
      stats: {
        totalListings: dashboarddata[2].totalListings,
        activeListings: dashboarddata[2].activeListings,
        activeListingsPct: dashboarddata[2].activeListingsPct,
        totalLeads: dashboarddata[2].totalLeads,
        savedProperties: 20,
        unreadMessages: 28,
      },
      leads: dashboarddata[1],
      listings: [
