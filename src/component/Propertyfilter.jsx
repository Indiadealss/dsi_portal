...
// Backend
  ...
  const ResidentalAppartment = [
    ...
    { title: 'Amenities', data: amenitiesFilter, name: 'anemateFilter', useref: useRef(null) },
    { title: 'Properties With Photos', data: 'input' },
    { title: 'Area', data: 'Rangeslider',min:0, max:10000, name: 'area', useref: useRef(null) },
    { title: 'Available From', data: availableFrom, name: 'availblefrom', useref: useRef(null) },
