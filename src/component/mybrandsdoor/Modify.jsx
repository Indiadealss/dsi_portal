        ...
        <div className='mx-5 pb-20'>
            ...
            <div className='border border-gray-300 rounded-xl py-2  mt-10'>
                ...
                <div className='shadow-sm bg-white mt-3 mx-5 px-2'>
                    <p><span>Subscribe For Updates From INDIADEALS GROUP</span></p>
                    <div class="flex items-center mb-4 mt-2 py-3">
                        ...
                        <label for="default-checkbox" class="select-none ms-2 text-xs font-medium text-heading">I agree to be contacted by INDIADEALS GROUP for similar properties or related services via What's app, phone(overring NDNC registration), SMS,e-mail etc.</label>
                    </div>
                </div>
