...
const Crmrightmenu = () => {
    ...
    const Listings = [
            {name:'All Listings', link:'/myindiadeals/all_listings'},
        ...
        const Projects = [
            {name: 'All Products',link:'/myindiadeals/all_listings/ALL'},
  ...
  return (
    <div className='w-[15%] '>
                    ...
                    <div className='w-[100%] bg-black py-5  left-0 h-screen overflow-y-auto'>
                        <div className='mx-3'>
                            <Link to={`/`}><span className='text-xs text-gray-500 font-medium'>My INDIADEALS</span></Link>
                        </div>
