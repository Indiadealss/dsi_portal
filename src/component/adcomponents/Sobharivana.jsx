...
const Sobharivana = () => {
  ...
  return (
      ...
      <div className="relative z-10 max-w-5xl space-y-4">
        ...
        <div className="space-y-1">
          <h2 className="text-xl md:text-3xl font-bold uppercase tracking-wider text-gray-100">
            <span className="text-white">SOBHA RIVANA</span>
          </h2>
          ...
          <div className="max-w-7xl mx-auto  px-4">
            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl  text-[#0f172a] mb-6">
                Why SOBHA RIVANA is in Tranding
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-2xl font-bold text-[#0f172a] mb-4"> SOBHA RIVANA</h3>
    ...
    <div className="bg-[#0f172a] min-h-screen p-10">
      <h1 className="text-white text-3xl mb-10 text-center ">Floor Plan Options</h1>
    ...
    <ContactSection projectName='SOBHA RIVANA' projectLocation='GH-11B, Greater Noida W Rd, Sector 1, Bisrakh Jalalpur, Greater Noida, Uttar Pradesh 201306'/>
    {customEnquiry && (
            <div>
