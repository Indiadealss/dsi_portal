...
import { getAllpropertiesDetailsUser, getPlainlistingWithleads } from '../../api/api';
...
const Plainlisting = () => {
    ...
    useEffect(() => {
        ...
        const fetchProperties = async () => {
            try {
                const res = await getPlainlistingWithleads(user.id, page, limit, status);
