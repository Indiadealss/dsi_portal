...
const blog = [
  ...
  {
    type: "p",
    text:"Let's walk through the smart way to secure your new home!"
  },
  {
    type: "h2",
  ...
  {
    type: "p",
    text: `${<b>Pro Tip:</b>}Get pre-approved for a home loan first so you know your exact buying power.`
  },
  {
    type: "h2",
  ...
  {
    type:"p",
    text: "Request an Encumbrance Certificate (EC) to ensure there are no active mortgages on the property. Investigate any ongoing family disputes, partition claims, or court stay orders. "
  },
  {
    type:"p",
